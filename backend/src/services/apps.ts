...
export function getAppTiles(): AppTile[] {
  const catalog: Array<{ id: string; name: string; url: string }> = [
    ...
    { id: "sonarr", name: "Sonarr", url: env.apps.sonarr || env.sonarrUrl },
    { id: "dozzle", name: "Dozzle", url: env.apps.dozzle },
    { id: "open-webui", name: "Open WebUI", url: env.apps.openWebui },
    { id: "pihole", name: "Pi-hole", url: env.apps.pihole || env.piholeUrl },
    { id: "plex", name: "Plex", url: env.apps.plex },
    { id: "immich", name: "Immich", url: env.apps.immich },
    { id: "radarr", name: "Radarr", url: env.apps.radarr || env.radarrUrl },
    {
      id: "qbittorrent",
      name: "qBittorrent",
      url: env.apps.qbittorrent || env.qbittorrentUrl,
    },
    { id: "netdata", name: "Netdata", url: env.apps.netdata || env.netdataUrl },
